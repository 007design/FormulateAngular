...
@UrlBinding("/data/editor/{view}")
public class EditorDataAction extends BaseActionBean implements DataAction {
	private static Logger log = org.apache.log4j.Logger.getLogger(EditorDataAction.class);
	...
	public Resolution defaultResolution() throws LoginException, AjaxException {
		...
		try {
			...
			String string = new ObjectMapper().configure(Feature.DEFAULT_VIEW_INCLUSION, false)
				.writerWithView(JsonViews.Editor.class)
			...
			throw new AjaxException(this, "editor", "data error");
		}
	}
}